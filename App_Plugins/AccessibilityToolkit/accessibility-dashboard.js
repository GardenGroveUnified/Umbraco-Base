...
export default class AccessibilityToolkitDashboard extends UmbElementMixin(HTMLElement) {
    ...
    #loadStyles() {
        ...
        link.setAttribute("href", "/App_Plugins/AccessibilityToolkit/accessibility-toolkit-style.css?v=1.10.46");
        this.shadowRoot.appendChild(link);
    }

    async #loadTemplate() {
        try {
            const response = await fetch("/App_Plugins/AccessibilityToolkit/accessibility-dashboard-template.html?v=1.10.46");
